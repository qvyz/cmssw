import pluginL1GTScales as sca
        ...
        for key , value in cutsdict.items():
            if key in self._PossibleCuts:
                if key in self._HWConversionFunctions:
                    self.Cuts[key] = _HWConversionFunctions[key](value)
                else:
                    self.Cuts[key] = value
...
class DoubleObjCond(Condition):
    ...
    def __init__(self):
        ...
        {
        "pt1_cut": self._Scales.to_hw_pT,
        "pt2_cut": self._Scales.to_hw_pT,
        "minEta1_cut": self._Scales.to_hw_eta,
        "maxEta1_cut": self._Scales.to_hw_eta,
        "minEta2_cut": self._Scales.to_hw_eta,
        "maxEta2_cut": self._Scales.to_hw_eta,
        "minPhi1_cut": self._Scales.to_hw_phi,
        "maxPhi1_cut": self._Scales.to_hw_phi,
        "minPhi2_cut": self._Scales.to_hw_phi,
        "maxPhi2_cut": self._Scales.to_hw_phi,
        "minDz1_cut": self._Scales.to_hw_dZ,
        "maxDz1_cut": self._Scales.to_hw_dZ,
        "minDz2_cut": self._Scales.to_hw_dZ,
        "maxDz2_cut": self._Scales.to_hw_dZ,
        "dEtaMin_cut": self._Scales.to_hw_eta,
        "dPhiMin_cut": self._Scales.to_hw_phi,
        "dRSquaredMin_cut": self._Scales.to_hw_RSquared,
        "invMassDiv2Min_cut": self._Scales.to_hw_InvMass,
        "invMassDiv2Max_cut": self._Scales.to_hw_InvMass
        }
        )
...
class SingleObjCond(Condition):
    ...
    def __init__(self):
        ...
        self._setHWConversionFunctions(
        {
        "pt_cut": self._Scales.to_hw_pT,
        "minEta_cut": self._Scales.to_hw_eta,
        "maxEta_cut": self._Scales.to_hw_eta,
        "minPhi_cut": self._Scales.to_hw_phi,
        "maxPhi_cut": self._Scales.to_hw_phi,
        "minDz_cut": self._Scales.to_hw_dZ,
        "maxDz_cut": self._Scales.to_hw_dZ,
        }
        )
        self._setInputTags(
            ["colTag"]
