...
def conditionwriter(obj):
    ...
    templateLoader = jinja2.FileSystemLoader(path)    # this has to be changed there seems to be a version of this thats called packageloader instead of filesystemloader
