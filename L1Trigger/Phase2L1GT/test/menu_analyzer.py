...
const char* getObjectName(l1t::P2GTCandidate::ObjectType objectType){
    switch(objectType) {
        ...
        case l1t::P2GTCandidate::GCTJets: return "GCTJets";
        case l1t::P2GTCandidate::GCTTaus: return "GCTTaus";
        case l1t::P2GTCandidate::GCTHtSum: return "GCTHtSum";
        case l1t::P2GTCandidate::GCTEtSum: return "GCTEtSum";
        case l1t::P2GTCandidate::GMTSaPromptMuons: return "GMTSaPromptMuons";
        case l1t::P2GTCandidate::GMTSaDisplacedMuons: return "GMTSaDisplacedMuons";
        case l1t::P2GTCandidate::GMTTkMuons: return "GMTTkMuons";
        case l1t::P2GTCandidate::GMTTopo: return "GMTTopo";
        case l1t::P2GTCandidate::GTTPromptJets: return "GTTPromptJets";
        case l1t::P2GTCandidate::GTTDisplacedJets: return "GTTDisplacedJets";
        case l1t::P2GTCandidate::GTTPhiCandidates: return "GTTPhiCandidates";
        case l1t::P2GTCandidate::GTTRhoCandidates: return "GTTRhoCandidates";
        case l1t::P2GTCandidate::GTTBsCandidates: return "GTTBsCandidates";
        case l1t::P2GTCandidate::GTTHadronicTaus: return "GTTHadronicTaus";
        ...
        case l1t::P2GTCandidate::CL2Jets: return "CL2Jets";
        case l1t::P2GTCandidate::CL2Taus: return "CL2Taus";
        case l1t::P2GTCandidate::CL2Electrons: return "CL2Electrons";
        case l1t::P2GTCandidate::CL2Photons: return "CL2Photons";
