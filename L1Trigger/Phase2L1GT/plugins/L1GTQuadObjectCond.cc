...
private:
  ...
  std::optional<ap_uint<16>> pt3_cut_;
  std::optional<ap_uint<16>> pt4_cut_;
  std::optional<ap_int<14>> minEta1_cut_;
  std::optional<ap_int<14>> maxEta1_cut_;
  std::optional<ap_int<14>> minEta2_cut_;
  std::optional<ap_int<14>> maxEta2_cut_;
  std::optional<ap_int<14>> minEta3_cut_;
  std::optional<ap_int<14>> maxEta3_cut_;
  std::optional<ap_int<14>> minEta4_cut_;
  std::optional<ap_int<14>> maxEta4_cut_;
  std::optional<ap_int<13>> minPhi1_cut_;
  std::optional<ap_int<13>> maxPhi1_cut_;
  std::optional<ap_int<13>> minPhi2_cut_;
  std::optional<ap_int<13>> maxPhi2_cut_;
  std::optional<ap_int<13>> minPhi3_cut_;
  std::optional<ap_int<13>> maxPhi3_cut_;
  std::optional<ap_int<13>> minPhi4_cut_;
  std::optional<ap_int<13>> maxPhi4_cut_;
  std::optional<ap_int<10>> minDz1_cut_;
  std::optional<ap_int<10>> maxDz1_cut_;
  std::optional<ap_int<10>> minDz2_cut_;
  std::optional<ap_int<10>> maxDz2_cut_;
  std::optional<ap_int<10>> minDz3_cut_;
  std::optional<ap_int<10>> maxDz3_cut_;
  std::optional<ap_int<10>> minDz4_cut_;
  std::optional<ap_int<10>> maxDz4_cut_;
  std::optional<ap_uint<8>> qual1_cut_;
  std::optional<ap_uint<8>> qual2_cut_;
  std::optional<ap_uint<8>> qual3_cut_;
  std::optional<ap_uint<8>> qual4_cut_;
  std::optional<ap_uint<2>> iso1_cut_;
  std::optional<ap_uint<2>> iso2_cut_;
  std::optional<ap_uint<2>> iso3_cut_;
  std::optional<ap_uint<2>> iso4_cut_;
