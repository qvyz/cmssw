...
private:
  ...
  const std::optional<ap_uint<16>> pt4_cut_;
  ...
  const std::optional<ap_int<14>> minEta4_cut_;
  const std::optional<ap_int<14>> maxEta4_cut_;
  ...
  const std::optional<ap_int<13>> minPhi4_cut_;
  const std::optional<ap_int<13>> maxPhi4_cut_;
